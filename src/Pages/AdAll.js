                        ...
                        {this.state.lists.map((ad) => (
                            <div key={{ad}} className="item">
                                <div className="ui small image">
                                    {ad.image? <img src={`data:image/png;base64,${ad.image}`} alt="Cinque Terre" width="600" height="400" /> :<img src="/images/default.jpg" alt="Cinque Terre" width="600" height="400"/>}
                                </div>
